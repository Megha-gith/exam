...
//select all post according to the user id
	$sqli= mysqli_query($conn,"SELECT * FROM postinfo WHERE id='$id'");
    $_post=mysqli_num_rows($sqli);
    if ($_post>1) {
    	echo " You have  ".$_post."  posts" ;
    }
    else{
    	echo " You have  ".$_post."  post" ;
    }
    echo "<br>";
    
   

if ($_post>0) {//if there are somes results do this
